const Pagination = ({
  ...
  const siguiente = () => {
    if (paginaActiva === paginastotales) return
    setpaginaActiva(paginaActiva + 1)
  }

  const atras = () => {
    if (paginaActiva === 1) return
    setpaginaActiva(paginaActiva - 1)
  }
  ...
  return (
   ...
   '>
          <ul className='flex items-center -mx-[6px] gap-4'>
            {paginaActiva > 1 ? (
              <button
                className='px-[6px]   border-3 border-black'
                onClick={atras}>
                <span className=''>
                  <svg
                    width='8'
            ...
            {paginas.map((pagina, i) => {
              return (
                <button
                  ...
                  <a
                    className={` ${
                      paginaActiva === pagina && 'bg-blue-600 '
      ...
      bg-gray-400
            ...
            {paginaActiva < paginastotales ? (
              <button className='px-[6px]' onClick={siguiente}>
                <span>
                  <svg
                    width='8'
                    height='15'
